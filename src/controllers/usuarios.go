...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIdToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New(fmt.Sprintf("O seu Id é %d, mas você está tentando deletar o usuário de id %d", usuarioIdToken, usuarioID)))
		return
	}
...
// SeguirUsuario permite que o usuario logado siga outro usuario
...
// ParaDeSeguirUsuario permite que o usuario pare de seguir outro usuario
...
// BuscarSeguidores permite que o usuario busque os seguidores de um usuario
...
// BuscarSeguindo quais usuarios que o usuario está seguindo
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A senha atual não condiz com o que está no banco."))
		return
	}
